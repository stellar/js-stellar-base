...
describe('StellarBase.makeTransaction', function() {
  describe('constructs a native payment transaction with one operation', function() {
    var source;
    var destination;
    var amount;
  ...
  describe('constructs a native payment transaction with timebounds', function() {
    it('should have have timebounds', function(done) {
      ...
      let transaction = StellarBase.makeTransaction({
        sourceAccount: source,
  ...
  describe('setTimeout', function() {
    it('not called', function() {
      ...
      ).to.throw(/TimeBounds has to be set/);
      expect(source.sequenceNumber()).to.be.equal('0');
    });
    ...
    it('timeout negative', function() {
      ...
      ).to.throw(/timeout cannot be negative/);
      expect(source.sequenceNumber()).to.be.equal('0');
    });

    it('sets timebounds with `timeout`', function() {
      let source = new StellarBase.Account(
        'GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ',
        '0'
      );
    ...
    it('sets timebounds with `timeBounds`', function() {
      let source = new StellarBase.Account(
        'GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ',
        '0'
      );
