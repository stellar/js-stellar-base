...
//
// ===========================================================================
xdr.struct("StellarValueSignedMsValue", [
  ["closeTimeMs", xdr.lookup("TimePointMilliseconds")],
  ["lcValueSignature", xdr.lookup("LedgerCloseValueSignature")],
]);
...
//
// ===========================================================================
xdr.struct("StellarValueProposedMsValue", [
  ["closeTimeMs", xdr.lookup("TimePointMilliseconds")],
  ["txSetHash", xdr.lookup("Hash")],
  ["previousLedgerHash", xdr.lookup("Hash")],
  ["previousLedgerVersion", xdr.lookup("Uint32")],
...
xdr.union("StellarValueExt", {
  ...
  switches: [
    ...
    ["stellarValueSignedMs", "signedMsValue"],
    ["stellarValueEmptyTxSetMs", "proposedMsValue"],
  ],
  arms: {
    lcValueSignature: xdr.lookup("LedgerCloseValueSignature"),
    proposedValue: xdr.lookup("StellarValueProposedValue"),
    signedMsValue: xdr.lookup("StellarValueSignedMsValue"),
    proposedMsValue: xdr.lookup("StellarValueProposedMsValue"),
  },
});
...
xdr.struct("ParallelTxsComponent", [
  ...
  ["executionStages", xdr.varArray(xdr.lookup("ParallelTxExecutionStage"), 2147483647)],
]);
...
xdr.struct("LedgerCloseMetaV2", [
  ...
  ["ledgerHeader", xdr.lookup("LedgerHeaderHistoryEntry")],
  ["txSet", xdr.lookup("GeneralizedTransactionSet")],
  ["txProcessing", xdr.varArray(xdr.lookup("TransactionResultMetaV1"), 2147483647)],
  ["upgradesProcessing", xdr.varArray(xdr.lookup("UpgradeEntryMeta"), 2147483647)],
  ["scpInfo", xdr.varArray(xdr.lookup("ScpHistoryEntry"), 2147483647)],
  ["totalByteSizeOfLiveSorobanState", xdr.lookup("Uint64")],
  ["evictedKeys", xdr.varArray(xdr.lookup("LedgerKey"), 2147483647)],
...
xdr.union("SorobanAuthorizedFunction", {
  ...
  switches: [
    ...
    ["sorobanAuthorizedFunctionTypeCreateContractV2HostFn", "createContractV2HostFn"],
  ],
  arms: {
...
xdr.struct("SorobanDelegateSignature", [
  ["address", xdr.lookup("ScAddress")],
  ["signature", xdr.lookup("ScVal")],
  ["nestedDelegates", xdr.varArray(xdr.lookup("SorobanDelegateSignature"), 2147483647)],
]);
...
xdr.struct("SorobanAddressCredentialsWithDelegates", [
  ...
  ["delegates", xdr.varArray(xdr.lookup("SorobanDelegateSignature"), 2147483647)],
]);
...
xdr.union("SorobanCredentials", {
  ...
  arms: {
    ...
    addressWithDelegates: xdr.lookup("SorobanAddressCredentialsWithDelegates"),
  },
});
...
xdr.union("HashIdPreimage", {
  ...
  switches: [
    ...
    ["envelopeTypeSorobanAuthorizationWithAddress", "sorobanAuthorizationWithAddress"],
  ],
  arms: {
    ...
    sorobanAuthorizationWithAddress: xdr.lookup("HashIdPreimageSorobanAuthorizationWithAddress"),
  },
});
...
//
// ===========================================================================
xdr.typedef("TimePointMilliseconds", xdr.lookup("Uint64"));
...
xdr.struct("LedgerCloseMetaBatch", [
  ...
  ["ledgerCloseMeta", xdr.varArray(xdr.lookup("LedgerCloseMeta"), 2147483647)],
]);
