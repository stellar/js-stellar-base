...
//
// FIXME: extend the ScVal structure to support conversions w/o a separate object
//
xdr.ScVal.toNative = xdr.ScVal.prototype.toNative = function (opts = {}) {
  return nativeToScVal(this, opts);
};
xdr.ScVal.fromNative = xdr.ScVal.prototype.fromNative = function (scv) {
